...
<div class="page-wrapper">
		<form action="update-price.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Edit gold</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control"  value="<?php echo $row['1gram_rate'];?>" id="one_gram_rate" name="1gram_rate">
										</input>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control"  value="<?php echo $row['8gram_rate'];?>" id="eight_gram_rate" name="8gram_rate">
										</input>
									</div>
								</div>
