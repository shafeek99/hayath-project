...
<div class="page-wrapper">
		<form action="update_back.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Edit Products</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
							<div class="row formtype">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="product_id" value="<?php echo $row['product_id'];?>"> </div>
								</div>
						
								<div class="col-md-6">
									<div class="form-group">
										<label>Product Name</label>
										<input class="form-control"  value="<?php echo $row['product_name'];?>" id="product_name" name="product_name">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control"  value="<?php echo $row['availability'];?>" id="$availability" name="availability">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text"  value="<?php echo $row['product_price'];?>" id="product_price" name="product_price">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Purity</label>
										<input class="form-control"  value="<?php echo $row['purity'];?>" id="purity" name="purity">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control"  value="<?php echo $row['metal_type'];?>" id="metal_type" name="metal_type">
