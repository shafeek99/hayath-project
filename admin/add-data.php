...
?>
		...
		<form action="insert-data.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Add data</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
							<div class="row formtype">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="metal_type" > </div>
								</div>
