...
$product_id=(rand(1000,100000));

?>


		<div class="page-wrapper">
		<form action="insert_back.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Add Products</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
							<div class="row formtype">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="product_id" value="<?php echo $product_id?>"> </div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input class="form-control" id="availabilty" name="availability">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Purity</label>
										<input class="form-control" id="purity" name="purity">
				...
				<button type="submit" class="btn btn-primary buttonedit1">submit product</button>
			</div>
			</form>
		</div>
	</div>
