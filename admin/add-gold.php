...
<div class="page-wrapper">
		<form action="insert-price.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

			<div class="content container-fluid">
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							<h3 class="page-title mt-5">Add gold</h3> </div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
							<div class="row formtype">
								<div class="col-md-6">
									...
									<label> 1gram rate</label>
										<input class="form-control"   id="1gram_rate" name="1gram_rate">
										</input>
								</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
									<label> 8gram rate</label>
										<input class="form-control"   id="8gram_rate" name="8gram_rate">
										</input> </div>
								</div>
						
						
								</div>
                                <button type="submit" class="btn btn-primary buttonedit1">submit data</button>
